...
local colors = require("solarized-oklab.colors")
...
function M.setup()
  ...
  theme.highlights = {
    ...
    MatchParen = { fg = c.red500, bg = c.bg, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    TabLineFill = { fg = c.base0, bg = c.base03 }, -- tab pages line, where there are no labels
