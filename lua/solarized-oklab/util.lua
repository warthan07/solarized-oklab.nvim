local ts = require("solarized-oklab.treesitter")
...
function M.invert_color(color)
  local hsluv = require("solarized-oklab.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("solarized-oklab", { clear = true })
...
function M.load(theme)
  ...
  vim.g.colors_name = "solarized-oklab"
